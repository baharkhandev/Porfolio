      ...
      <div className="container">
        <nav className="flex items-center justify-between py-4">
          ...
          <ul className="hidden md:flex items-center gap-6 text-sm">
            ...
            <li>
              <a 
                href="https://drive.google.com/file/d/1zlxiJk7lo1SoyCnBJqIoqPM2jnjBUqhM/view?usp=sharing" 
                download="Resume.pdf" 
        ...
        <div className="md:hidden border-t border-border bg-background">
          <div className="container py-4">
            <ul className="flex flex-col gap-3 text-sm">
              ...
              <li>
                <a 
                  href="https://drive.google.com/file/d/15Aho4cor0yqXlihwrqe4vWl-wFCGvgo2/view?usp=sharing" 
                  download="Resume.pdf" 
                  className="inline-flex h-9 items-center rounded-md border border-border px-3 text-sm hover:bg-accent hover:text-accent-foreground transition-colors"
                >
                  Resume
