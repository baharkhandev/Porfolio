              ...
              <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-4">
                {category.skills.map((skill, skillIndex) => (
                  ...
                  >
                        ...
                        >
                          {skill.icon ? (
                            <skill.icon
                              ...
                              style={skill.color ? { color: skill.color } : { color: 'currentColor' }}
                            />
                          ) : (
                            <span className="h-8 w-8 flex items-center justify-center font-bold text-muted-foreground">?</span>
                          )}
                        </motion.div>
                      </div>
                    </div>
                    ...
                    <motion.span
                      className="block text-center text-xs text-muted-foreground group-hover:text-foreground transition-colors duration-300 mt-2 px-1 leading-tight break-words w-full"
                      whileHover={{ y: -2 }}
                    >
                      {skill.name}
                    </motion.span>
